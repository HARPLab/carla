...
class ReplayAgent(object):
    ...
    def __init__(self, args):        
        ...
        # track the sensor objects so they can be destroyed at exit        
        self.sensor_actor_list = list()
        self.ego_cam = None
        self.ego_cam_left = None
        self.ego_cam_right = None
        self.sem_cam = None
        ...
        self.ego_gnss = None
        self.ego_imu = None
        self.ego_speedo = None

        return

    def _destroy(self):
        for actor in self.sensor_actor_list:
