...
ALightBall::ALightBall()
{
    ...
    static ConstructorHelpers::FObjectFinder<UStaticMesh> SphereVisualAsset(
        TEXT("/Game/LightBallMaterial/Shape_Sphere.Shape_Sphere"));
    ...
    static ConstructorHelpers::FObjectFinder<UMaterialInstance> MaterialAsset(
        TEXT("/Game/LightBallMaterial/ERed.ERed"));
