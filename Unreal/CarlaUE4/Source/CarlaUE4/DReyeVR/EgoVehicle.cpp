...
void AEgoVehicle::ReadConfigVariables()
{
    ...
    // awareness mode
    GeneralParams.Get("AwarenessMode", "AwarenessModeEnabled", AwarenessModeEnabled);
    GeneralParams.Get("AwarenessMode", "AwarenessVelMode", AwarenessVelMode);
    GeneralParams.Get("AwarenessMode", "AwarenessPosMode", AwarenessPosMode);
}
