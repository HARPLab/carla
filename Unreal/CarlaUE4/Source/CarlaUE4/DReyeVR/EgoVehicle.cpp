...
{
    RearMirror = NewObject<AMirror>();
    RearMirror->Initialize(this, "Rear");

    LeftMirror = NewObject<AMirror>();
    LeftMirror->Initialize(this, "Left");

    RightMirror = NewObject<AMirror>();
    RightMirror->Initialize(this, "Right");
}
